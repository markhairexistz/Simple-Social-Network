...
<body style = "background-image:url(img/web-development-banner2.jpg); background-attachment:fixed; background-size:cover; ">
	...
	<div class="collapse navbar-collapse" id="collapse_target">
        ...
        <li CLass="nav-item">
          <a class="nav-link" href = "" data-toggle="modal" data-target="#postmodal">Post</a>
        </li>
    ...
    <div class="modaldialog" style="width:500px;">
      <div class="modal-content">
       ...
       <div class="modal-body">
       	<br/>
       <input type="file" name="postimage" style="position:absolute;margin-top:-30px; margin-left:-230px;"><br/><br/>
